...
const specialities = [
  {
    ...
    description: "Women's health, pregnancy care, normal delivery, painless delivery, high-risk pregnancy management, and infertility treatment in Jharsuguda.",
  },
  {
    icon: Baby,
    title: 'Maternity Care',
    description: 'Safe motherhood services with modern labour room, postnatal care and experienced obstetricians in Jharsuguda.',
  },
  {
    icon: Pill,
    title: 'General Medicine',
    description: 'Diagnosis and treatment for fever, infections, diabetes, hypertension, and other medical conditions in Jharsuguda.',
  },
  {
    icon: Scissors,
    title: 'General Surgery',
    description: 'Minor and major surgical procedures with modern operation theatre facilities in Jharsuguda.',
  },
  {
    icon: Bone,
    title: 'Orthopaedics',
    description: 'Bone, joint, fracture, arthritis, and trauma care by experienced orthopaedic surgeons in Jharsuguda.',
  },
  {
    icon: Stethoscope,
    title: 'Paediatrics',
    description: 'Complete healthcare services for newborns, infants, children, and adolescents in Jharsuguda.',
  },
  {
    icon: Activity,
    title: 'Advanced NICU',
    description: 'Specialized intensive care for premature and critically ill newborn babies at A Square Hospital Jharsuguda.',
  },
  {
    icon: Leaf,
    title: 'Fertility Care & IVF',
    description: 'Consultation and advanced IVF solutions for infertility and reproductive health in Jharsuguda.',
  },
  {
    icon: Microscope,
    title: 'Diagnostics',
    description: 'Ultrasound, pathology, and routine health investigations with accurate, timely results.',
  },
  {
    icon: Ambulance,
    title: 'Emergency Care',
    description: '24/7 prompt medical attention for urgent and critical cases at A Square Hospital Jharsuguda.',
  },
  {
    icon: ShieldCheck,
    title: 'Preventive Health Check-ups',
    description: 'Routine screenings, health packages and wellness programs for better long-term health.',
  },
];
...
export function Specialties() {
  return (
    <>
      <Helmet>
        <title>Medical Specialities in Jharsuguda | Gynaecology, NICU, IVF, Surgery — A Square Hospital</title>
        <meta name="description" content="A Square Hospital Jharsuguda specialises in gynaecology, maternity care, NICU, IVF & fertility, orthopaedics, paediatrics, surgery, diagnostics & emergency care. Trusted hospital in Odisha." />
        <meta name="keywords" content="specialities A Square Hospital, gynaecologist Jharsuguda, NICU Jharsuguda, IVF specialist Jharsuguda, orthopaedic doctor Jharsuguda, paediatrician Jharsuguda, best doctor Jharsuguda" />
        <link rel="canonical" href="https://asquarehospital.com/specialties" />
      </Helmet>
            ...
            <div className="relative max-w-4xl w-full p-8 md:p-12 rounded-3xl bg-white border border-blue-50 shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden group transition-all duration-500 hover:shadow-[0_8px_30px_rgba(0,119,182,0.12)] hover:-translate-y-1">
              ...
              <div className="relative z-10 text-center">
                ...
                <p className="text-xl md:text-3xl font-medium leading-relaxed text-gray-700">
                  A Square Hospital continues to grow with one promise —
