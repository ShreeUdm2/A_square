        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6 mb-14">
          {offers.map((offer) => {
            ...
            return (
              <div
                key={offer.title}
                className="group relative bg-white border border-gray-100 rounded-2xl p-5 sm:p-8 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 overflow-hidden"
              >
